...
public class InternetAddress {
    public static final String HOST_IP = "172.16.169.139";
    public static final String HOST = "http://172.16.169.139:8080";
    ...
    public static final String CHANGE_PASS_URL = HOST + "/wonderfulChat/changePass";
    public static final String CHANGE_FIELD_URL = HOST + "/wonderfulChat/changeField";
    public static final String CHANGE_REMARK_URL = HOST + "/wonderfulChat/changeRemark";
    public static final String FRIEND_LIST_URL = HOST + "/wonderfulChat/friendList";
    ...
    public static final String DELETE_FRIEND_URL = HOST + "/wonderfulChat/deleteFriend";
